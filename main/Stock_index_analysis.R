setwd("C:\\Users\\howard\\Desktop\\PhD Research\\LRD Resampling\\Proj 2 Estimation of Hermite rank\\Hermite_rank_code\\main")
...
source("C:\\Users\\howard\\Desktop\\PhD Research\\LRD Resampling\\Proj 2 Estimation of Hermite rank\\Hermite_rank_code\\functions\\Hermite_rank_estimator.R")
...
if(sys.nframe() == 0){
  ...
  SnP500 <- read.csv("C:\\Users\\howard\\Desktop\\PhD Research\\LRD Resampling\\Proj 2 Estimation of Hermite rank\\Code\\data\\SnP500_WSJ.csv")
  SnP500 <- SnP500 %>% 
  ...
  Hermite_index_analysis_func <- function(df, HE_by, lag=60){
    ...
    # He_by: by parameter of Hermite rank est for k, DJI=4, Snp500=1
    ...
    cov_plot <- cov_comparison_df %>% 
      ...
      ggtitle(TeX(
        paste0('$Sample\\,Correlation\\,for\\,Z_{t,',i,'}\\,vs\\,LRD\\,Correlation\\,(\\alpha =$', 
               round(index_output$est_summary_df[3], digits = 4), ')')
        )) + 
